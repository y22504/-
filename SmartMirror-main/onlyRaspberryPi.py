...
def write_virtual_pin_handler(pin, value):
    if value == ['1']:
        requests.post('http://'+RaspberryPiIPAdress+':8080/api/module/youtube/youtubeload',
                      headers=headers, data=dataPlayload3)
...
def write_virtual_pin_handler(pin, value):
    if value == ['1']:
        requests.post('http://'+RaspberryPiIPAdress+':8080/api/module/youtube/youtubeload',
                      headers=headers, data=dataPlayload4)
...
if __name__ == "__main__":
    ...
    dataPlayload2 = '{"type": "playlist", "listType": "playlist", "id": "PL4fGSI1pDJn4-UIb6RKHdxam-oAUULIGB", "shuffle": "true", "loop": "true", "autoplay": "true"}'
    dataPlayload3 = '{"type": "playlist", "listType": "playlist", "id": "PL4fGSI1pDJn5FhDrWnRp2NLzJCoPliNgT", "shuffle": "true", "loop": "true", "autoplay": "true"}'
    dataPlayload4 = '{"type": "playlist", "listType": "playlist", "id": "PLxr0iPdlkA-BLv8e6Ni-RViNtppUxexEw", "shuffle": "true", "loop": "true", "autoplay": "true"}'
